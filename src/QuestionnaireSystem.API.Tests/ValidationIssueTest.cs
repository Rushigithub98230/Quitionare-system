...
public class ValidationIssueTest : IDisposable
{
    ...
    public ValidationIssueTest()
    {
        // Setup in-memory database
        var services = new ServiceCollection();
        services.AddDbContext<QuestionnaireDbContext>(options =>
            options.UseInMemoryDatabase("ValidationIssueTest_" + Guid.NewGuid()));
    ...
    [Fact]
    public async Task Test_Validation_WithEmptyResponses_ShouldFail()
    {
        // Arrange - Test with empty responses for required questions
        ...
        var submitDto = new SubmitResponseDto
        {
            ...
            Responses = new List<CreateQuestionResponseDto>
            {
                ...
                new CreateQuestionResponseDto
                {
                    ...
                    TextResponse = "A+", // This should be selectedOptionIds instead
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("beffceca-fd3f-4675-a9f4-759233c50462"),
                    TextResponse = "Male", // This should be selectedOptionIds instead
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("d1e7e5cb-1d49-4657-8f99-965db8b32093"),
                    TextResponse = "fasfasf",
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("c825e6fa-7a0c-4538-a5d0-a818cdf7e786"),
                    TextResponse = "Diabetes, Hypertension", // This should be selectedOptionIds instead
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("66c81a7a-f387-4c06-b236-791e8225b585"),
                    TextResponse = "Marathi, eeeee", // This should be selectedOptionIds instead
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("92893113-416c-4a7f-8795-09e289db0c3f"),
                    TextResponse = "", // Empty date response
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("db577ab3-5f62-4644-a27f-d5d571ed920f"),
                    TextResponse = "File: Healthcare_SaaS_Model_Updated.pdf",
                    SelectedOptionIds = new List<Guid>(),
                    FileUrl = "/uploads/35097df8-145b-4e7c-9277-08d5558991fa.pdf"
                },
                new CreateQuestionResponseDto
                {
                ...
                new CreateQuestionResponseDto
                {
                    ...
                    TextResponse = "rcpatient@yopmail.com",
                    SelectedOptionIds = new List<Guid>()
                }
            }
        };
        ...
        Assert.Contains("must have a valid response", result.Message);
    }

    [Fact]
    public async Task Test_Validation_WithProperOptionIds_ShouldSucceed()
    {
        // Arrange - Test with proper option IDs instead of text responses
        var tokenModel = new TokenModel
        {
            UserId = AdminConstants.AdminUserId,
            Role = "Admin",
        ...
        var bloodTypeOptionId = _context.QuestionOptions.First(o => o.OptionValue == "A+").Id;
        var maleOptionId = _context.QuestionOptions.First(o => o.OptionValue == "Male").Id;
        var diabetesOptionId = _context.QuestionOptions.First(o => o.OptionValue == "Diabetes").Id;
        var hypertensionOptionId = _context.QuestionOptions.First(o => o.OptionValue == "Hypertension").Id;
        var englishOptionId = _context.QuestionOptions.First(o => o.OptionValue == "English").Id;
        ...
        var submitDto = new SubmitResponseDto
        {
            ...
            Responses = new List<CreateQuestionResponseDto>
            {
                ...
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("67abd319-dade-4bda-9353-5aaff37ebdb4"),
                    TextResponse = null,
                    SelectedOptionIds = new List<Guid> { bloodTypeOptionId }
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("beffceca-fd3f-4675-a9f4-759233c50462"),
                    TextResponse = null,
                    SelectedOptionIds = new List<Guid> { maleOptionId }
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("d1e7e5cb-1d49-4657-8f99-965db8b32093"),
                ...
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("c825e6fa-7a0c-4538-a5d0-a818cdf7e786"),
                    TextResponse = null,
                    SelectedOptionIds = new List<Guid> { diabetesOptionId, hypertensionOptionId }
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("66c81a7a-f387-4c06-b236-791e8225b585"),
                    TextResponse = null,
                    SelectedOptionIds = new List<Guid> { englishOptionId }
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("92893113-416c-4a7f-8795-09e289db0c3f"),
