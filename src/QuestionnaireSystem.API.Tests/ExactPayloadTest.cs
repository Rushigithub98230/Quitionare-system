...
public class ExactPayloadTest : IDisposable
{
    ...
    public ExactPayloadTest()
    {
        // Setup in-memory database
        var services = new ServiceCollection();
        services.AddDbContext<QuestionnaireDbContext>(options =>
            options.UseInMemoryDatabase("ExactPayloadTest_" + Guid.NewGuid()));
    ...
    [Fact]
    public async Task Test_ExactPayload_FromFrontend_ShouldSucceed()
    {
        // Arrange - This is the exact payload being sent from frontend
        ...
        var submitDto = new SubmitResponseDto
        {
            ...
            Responses = new List<CreateQuestionResponseDto>
            {
                ...
                new CreateQuestionResponseDto
                {
                    ...
                    TextResponse = "Diabetes, Hypertension",
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
                    QuestionId = Guid.Parse("66c81a7a-f387-4c06-b236-791e8225b585"),
                    TextResponse = "Marathi, eeeee",
                    SelectedOptionIds = new List<Guid>()
                },
                new CreateQuestionResponseDto
                {
